...
fname_out_AE_Corp1 <- paste0(dptdir,"KPI_aGHG_Corp1", "_", outdate,".csv")
fname_out_AE_Corp2 <- paste0(dptdir,"KPI_aGHG_Corp2", "_", outdate,".csv")
fname_out_AE_PrFin1 <- paste0(dptdir,"KPI_aGHG_PrFin1", "_", outdate,".csv")
fname_out_AE_PrFin2 <- paste0(dptdir,"KPI_aGHG_PrFin2", "_", outdate,".csv")
fname_out_AE_PrEq1 <- paste0(dptdir,"KPI_aGHG_PrEq1", "_", outdate,".csv")
fname_out_AE_PrEq2 <- paste0(dptdir,"KPI_aGHG_PrEq2", "_", outdate,".csv")
fname_out_AE_FI1 <- paste0(dptdir,"KPI_aGHG_FI1", "_", outdate,".csv")
fname_out_AE_FI2 <- paste0(dptdir,"KPI_aGHG_FI2", "_", outdate,".csv")
