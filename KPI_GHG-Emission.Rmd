...
fname_out_AE_Un1 <- paste0(inddir,"KPI_aGHG_Un1", "_", outdate,".csv")
fname_out_AE_Un2 <- paste0(inddir,"KPI_aGHG_Un2", "_", outdate,".csv")
...
write.csv2(AE_Un1, file = fname_out_AE_Un1, row.names = FALSE,
           fileEncoding = "UTF-8")
...
write.csv2(AE_Un2, file = fname_out_AE_Un2, row.names = FALSE,
           fileEncoding = "UTF-8")
...
colnames(AE_Un1) <- paste0(colnames(AE_Un1),"_1")
colnames(AE_Un2) <- paste0(colnames(AE_Un2),"_2")
